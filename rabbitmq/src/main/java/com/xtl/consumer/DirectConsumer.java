...
public class DirectConsumer {
    ...
    private final static String QUEUE_NAME_01="direct_01";
    private final static String QUEUE_NAME_02="direct_02";
...
//        将队列绑定到交换机上
        channel.queueBind(QUEUE_NAME_01,EXCHANGE_NAME,"hello_world");
        channel.queueBind(QUEUE_NAME_02,EXCHANGE_NAME,"hello.world");
        //5 创建消费者
